...
public class RabbitConfig {
    @Value("${com.sen.firstqueue}")
    private String firstQueue;

    @Value("${com.sen.secondqueue}")
    private String secondQueue;

    @Value("${com.sen.thirdqueue}")
    private String thirdQueue;

    @Value("${com.sen.fourthqueue}")
    ...
    public Binding bindFirst(@Qualifier("vipFirstQueue") Queue queue, @Qualifier("vipDirectExchange") DirectExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("rabbit.best");
    }
