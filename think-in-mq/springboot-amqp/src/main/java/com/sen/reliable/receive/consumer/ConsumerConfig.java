package com.sen.reliable.receive.consumer;
...
public class ConsumerConfig {
    ...
    @Bean("gpqueue")
    public Queue queue() {
        return new Queue("SEN_RELIABLE_RECEIVE_QUEUE", true, false, false, new HashMap<>());
    }

    @Bean("gpexchange")
    public DirectExchange exchange() {
        return new DirectExchange("SEN_RELIABLE_RECEIVE_EXCHANGE", true, false, new HashMap<>());
    }

    @Bean
    public Binding binding(@Qualifier("gpqueue") Queue queue, @Qualifier("gpexchange") DirectExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("rabbit.test.reliable");
    }
    ...
    public MessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory) {
        ...
        messageListenerContainer.setQueueNames("SEN_RELIABLE_RECEIVE_QUEUE");
