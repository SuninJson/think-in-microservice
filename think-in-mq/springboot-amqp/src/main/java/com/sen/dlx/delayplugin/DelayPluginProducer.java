package com.sen.dlx.delayplugin;

import com.sen.dlx.ttl.DlxSender;
 ...
 */
@ComponentScan(basePackages = "com.sen.dlx.delayplugin")
public class DelayPluginProducer {
    public static void main(String[] args) {
        ...
        // 不能在本地测试，必须发送消息到安装了插件的服务端
        rabbitTemplate.send("SEN_DELAY_EXCHANGE", "#", message);
